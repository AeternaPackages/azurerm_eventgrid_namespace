...
module "eventgrid_namespaces" {
  source               = "git::https://github.com/AeternaModules/azurerm_eventgrid_namespace.git?ref=v4.80.0"
  eventgrid_namespaces = local.eventgrid_namespaces
}

module "eventgrid_namespace_topics" {
  source                     = "git::https://github.com/AeternaModules/azurerm_eventgrid_namespace_topic.git?ref=v4.80.0"
